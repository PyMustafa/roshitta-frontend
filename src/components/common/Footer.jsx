...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-700 pb-4 pt-8 px-6">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-start md:items-start text-center md:text-left gap-8">

        {/* First column - Logo and description */}
        <div className="w-full md:w-1/3 md:mr-auto md:ml-4 space-y-4 order-1 md:order-1">
        ...
        <div className="w-full md:w-1/6 md:mr-4 md:ml-auto space-y-4 order-3 md:order-3">
        ...
        <div className="w-full md:w-1/6 md:ml-auto space-y-4 order-4 md:order-4">
